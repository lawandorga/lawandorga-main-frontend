    ...
    <div class="px-2 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="p-2 rounded-lg shadow-lg bg-formcolor sm:p-3">
        <div class="flex flex-wrap items-center justify-between">
          ...
          <div
            class="order-3 w-full mt-2 shrink-0 sm:order-2 sm:mt-0 sm:w-auto"
          >
            <router-link
              :to="to"
          ...
          <div class="order-2 shrink-0 sm:order-3 sm:ml-2">
            <button
              v-if="close"
              type="button"
              class="flex p-2 -mr-1 rounded-md cursor-pointer hover:bg-blue-500/10 focus:ring-2 focus:ring-blue-500/50 focus:outline-none"
              @click="emit('close')"
            >
