...
const updateTabOnLoading = () => {
  ...
  const routeValue = route.query.selected ? parseInt(route.query.selected as string) : undefined;
  const defaultValue = defaultTab ? parseInt(defaultTab.value as string) : undefined;
